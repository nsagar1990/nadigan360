...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Movie_Gallery.interactionCount'
        db.add_column(u'nd360_movie_gallery', 'interactionCount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Movie_Gallery.interactionCount'
        db.delete_column(u'nd360_movie_gallery', 'interactionCount')
