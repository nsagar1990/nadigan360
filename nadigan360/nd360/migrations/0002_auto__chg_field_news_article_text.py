...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'News_Article.text'
        db.alter_column(u'nd360_news_article', 'text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'News_Article.text'
        db.alter_column(u'nd360_news_article', 'text', self.gf('django.db.models.fields.CharField')(max_length=255))
